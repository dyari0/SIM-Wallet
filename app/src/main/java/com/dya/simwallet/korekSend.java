...
public class korekSend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_korek_send);
        ...
        btnNardn = (Button)findViewById(R.id.daxlKorek);
        ...
        editSim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(korekSend.this,select.class);
        ...
        bottom_navigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id==R.id.developer){
                     Intent intent = new Intent(korekSend.this,Developer.class);
                    intent.putExtra("sim",sim);
                     startActivity(intent);
                    finish();
                }
                else  if (id==R.id.wallet){
                    Intent intent = new Intent(korekSend.this,ACKorek.class);
                    startActivity(intent);
                    finish();
                }
                else  if (id==R.id.send){
                    Toast.makeText(korekSend.this,"it is SendPage", Toast.LENGTH_SHORT).show();
                }
                return true;
            }
        });
        ...
        btnZanyn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(korekSend.this, "Please Grant Permission ", Toast.LENGTH_SHORT).show();
                    requestPermission();
                }
                else {
                    startActivity(intent);
        ...
        btnNardn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String hashCode="#";
                intent.setData(Uri.parse(String.format("tel:%s",Uri.encode(num+PNum+KNum+hashCode))));
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(korekSend.this,new String[]{Manifest.permission.CALL_PHONE},1);
    }
}